import { deleteProgressSettingsFor, getSetting, setSetting } from '@main/db/queries';
...
export function clearProgress(userId: number): ClearProgressResult {
  const cleared = deleteProgressSettingsFor(userId);
